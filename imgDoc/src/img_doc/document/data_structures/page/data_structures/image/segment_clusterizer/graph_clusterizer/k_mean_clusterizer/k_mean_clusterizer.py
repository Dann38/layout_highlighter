...
from img_doc.document.data_structures.page.data_structures.image import ImageSegment
from img_doc.document.data_structures.page.data_structures.image.segment_relationship import Graph
import numpy as np
